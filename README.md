...
## For a **standalone C++ implementation** (without Godot) which is based on my initial implementation, see: [https://github.com/baptiste-genest/ImplicitUVs](https://github.com/baptiste-genest/ImplicitUVs)
